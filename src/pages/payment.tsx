    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="mt-6 mb-2 text-left">
        <label className="text-white text-xs cursor-pointer select-none">
          ...
          Confirm your intent to use <span className="text-pink-500">Visa / Mastercard</span> checkout by checking the signature box. You can view your customer rights by reviewing our <a onClick={(e) => e.stopPropagation()} className="text-purple-500 underline" href="https://bacpack.netowrk/terms-of-service" target="_blank">terms of service (TOS)</a> and <a onClick={(e) => e.stopPropagation()} className="text-purple-500 underline" href="https://bacpack.netowrk/privacy-policy" target="_blank">privacy policy (PP)</a>.
        </label>
